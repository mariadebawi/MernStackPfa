...
const DataTable = ({ classes, ...props }) => {
	...
	const nameChange = async (event) => {
		...
		name = value
		await setName(value)
		props.fetchPagination(1, rowsPerPage,  value)
	}
...
export default connect(itemStateToProps, itemActionToProps)(withStyles(styles)(DataTable));
